...
public class LightController : MonoBehaviour
{
    ...
    public void deleteLight()
    {
        ...
        {
            Object.Destroy(light1.LightGameObject); // Destroys the actual GameObject in the scene
            light1 = null; // Clears the reference to the CustomLight object
        }
        else
        {
            Debug.LogWarning("No light to delete or it has already been deleted.");
        }
    }
